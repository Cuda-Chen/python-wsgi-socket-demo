...
def wsgihandler(environ, start_reponse):
    ...
    #r = Request(environ)
    return [('You asked to '+environ['REQUEST_METHOD']+' '+environ['PATH_INFO']).encode('utf-8'), 
            b' some more data',
            b'\r\n']

asgi_application = WsgiToAsgi(wsgihandler)
